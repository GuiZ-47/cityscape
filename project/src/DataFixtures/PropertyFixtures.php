    ...
    public function load(ObjectManager $manager): void
    {
        ...
        for ($ii = 1; $ii <100; $ii++) {
            ...
            for ($i = 0; $i < rand(1, 3); $i++) {
                ...
                $imageName ="property". rand(1, 100) . '.jpg';

                while (!file_exists('/var/www/project/public/assets/images/property/' . $imageName)) {
                    $imageFile = curl_get_contents($url);
                    $imagePath = '/var/www/project/public/assets/images/property/' . $imageName;
